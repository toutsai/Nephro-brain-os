...
==================================
一次性寫入 KDIGO、KDOQI、NICE、ERBP 臨床指引 metadata 到 Firestore guidelines collection。
...
GUIDELINES = [
    ...
    # ── NICE ──
    {
        ...
        "title_zh": "慢性腎臟病：評估與管理",
        "year": 2021,
        "url": "https://www.nice.org.uk/guidance/ng203",
        "status": "current",
        "summary_zh": "涵蓋 CKD 的偵測、分期、轉介標準、藥物治療（含 SGLT2i）及監測頻率建議。",
        "key_topics": ["CKD 分期", "轉介標準", "SGLT2i", "eGFR", "白蛋白尿"],
        "rag_status": "not_indexed",
    },
    {
        "org": "NICE",
        "topic": "AKI",
        "title": "Acute Kidney Injury: Prevention, Detection and Management (CG169)",
        "title_zh": "急性腎損傷：預防、偵測與管理",
        "year": 2019,
        "url": "https://www.nice.org.uk/guidance/cg169",
        "status": "current",
        "summary_zh": "AKI 的風險辨識、預警系統、處置流程及後續追蹤建議。",
        "key_topics": ["AKI 預防", "風險辨識", "預警評分", "處置流程"],
        "rag_status": "not_indexed",
    },
    {
        "org": "NICE",
        "topic": "ESRD/HD",
        "title": "Renal Replacement Therapy and Conservative Management (NG107)",
        "title_zh": "腎臟替代療法與保守治療",
        "year": 2018,
        "url": "https://www.nice.org.uk/guidance/ng107",
        "status": "current",
        "summary_zh": "RRT 模式選擇（HD、PD、移植）、保守治療、共享決策及預後溝通。",
        "key_topics": ["RRT 選擇", "保守治療", "共享決策", "透析時機"],
        "rag_status": "not_indexed",
    },
    {
        "org": "NICE",
        ...
        "title_zh": "成人高血壓：診斷與管理",
        "year": 2023,
        "url": "https://www.nice.org.uk/guidance/ng136",
        "status": "current",
        "summary_zh": "高血壓的診斷（含 ABPM）、藥物治療階梯、CKD 患者的血壓目標。",
        "key_topics": ["ABPM", "藥物治療階梯", "血壓目標", "難治性高血壓"],
        "rag_status": "not_indexed",
    },
    {
        "org": "NICE",
        ...
        "title_zh": "成人第二型糖尿病：管理",
        "year": 2022,
        "url": "https://www.nice.org.uk/guidance/ng28",
        "status": "current",
        "summary_zh": "第二型糖尿病的血糖管理、藥物選擇（含 SGLT2i、GLP-1 RA）、心腎保護策略。",
        "key_topics": ["血糖控制", "SGLT2i", "GLP-1 RA", "心血管風險", "腎臟保護"],
        "rag_status": "not_indexed",
    },
    # ── ERBP ──
    {
        "org": "ERBP",
        "topic": "ESRD/HD",
        "title": "Dialysis Initiation, Modality Choice and Prescription",
        "title_zh": "透析起始、模式選擇與處方",
        "year": 2017,
        "url": "https://academic.oup.com/ndt/article/32/suppl_2/ii1/3056950",
        "status": "current",
        "summary_zh": "透析起始時機、HD 與 PD 模式選擇、個人化透析處方建議。",
        "key_topics": ["透析起始", "模式選擇", "透析處方", "漸進式透析"],
        "rag_status": "not_indexed",
    },
    {
        "org": "ERBP",
        "topic": "CKD",
        "title": "Management of Older Patients with CKD",
        "title_zh": "老年 CKD 患者管理",
        "year": 2016,
        "url": "https://academic.oup.com/ndt/article/31/suppl_2/ii1/2196191",
        "status": "current",
        "summary_zh": "老年 CKD 患者的保守治療、透析決策、衰弱評估、共享決策。",
        "key_topics": ["老年照護", "衰弱評估", "保守治療", "共享決策"],
        "rag_status": "not_indexed",
    },
    {
        "org": "ERBP",
        ...
        "title_zh": "CKD 貧血管理",
        "year": 2021,
        "url": "https://academic.oup.com/ndt/article/36/Supplement_2/ii1/6375780",
        "status": "current",
        "summary_zh": "歐洲腎臟最佳實踐的貧血管理建議，涵蓋鐵劑、ESA 及 HIF-PHI 的定位。",
        "key_topics": ["ESA", "鐵劑", "HIF-PHI", "Hb 目標"],
        "rag_status": "not_indexed",
    },
    {
        "org": "ERBP",
        "topic": "Transplant",
        "title": "Post-transplantation Diabetes Mellitus",
        "title_zh": "移植後糖尿病",
        "year": 2024,
        "url": "https://academic.oup.com/ndt/article/39/3/391/7513569",
        "status": "current",
        "summary_zh": "腎移植後糖尿病的篩檢、診斷標準、血糖管理及免疫抑制劑調整。",
        "key_topics": ["PTDM", "移植後血糖", "免疫抑制劑", "SGLT2i"],
        "rag_status": "not_indexed",
    },
    {
        "org": "ERBP",
        "topic": "ESRD/HD",
        "title": "Vascular Access Creation and Use for Haemodialysis",
        "title_zh": "血液透析血管通路的建立與使用",
        "year": 2019,
        "url": "https://academic.oup.com/ndt/article/34/Supplement_2/ii1/5552028",
        "status": "current",
        "summary_zh": "血管通路類型選擇、建立時機、術後監測及併發症處理的歐洲建議。",
        "key_topics": ["AVF", "AVG", "導管", "通路監測", "術前評估"],
        "rag_status": "not_indexed",
    },
    {
        "org": "ERBP",
        "topic": "CKD-MBD",
        "title": "CKD-MBD: ERBP Position Statement",
        "title_zh": "CKD 礦物質骨骼代謝異常：ERBP 立場聲明",
        "year": 2019,
        "url": "https://academic.oup.com/ndt/article/34/2/208/5266173",
        "status": "current",
        "summary_zh": "ERBP 對 KDIGO CKD-MBD 指引的評論與歐洲臨床實踐建議。",
        "key_topics": ["PTH 目標", "磷結合劑", "Calcimimetics", "Vitamin D"],
        "rag_status": "not_indexed",
    },
    {
        "org": "ERBP",
        "topic": "Transplant",
        "title": "Long-term Management of Kidney Transplant Recipients",
        "title_zh": "腎臟移植受者的長期管理",
        "year": 2002,
        "url": "https://academic.oup.com/ndt/article/17/suppl_4/1/1816587",
        "status": "current",
        "summary_zh": "移植後長期照護，包括免疫抑制維持、感染預防、心血管及腫瘤篩檢。",
        "key_topics": ["移植後照護", "免疫抑制", "感染預防", "腫瘤篩檢"],
        "rag_status": "not_indexed",
    },
    {
        "org": "ERBP",
        "topic": "GN",
        "title": "Lupus Nephritis (EULAR/ERA-EDTA Joint Recommendations)",
        "title_zh": "狼瘡腎炎（EULAR/ERA-EDTA 聯合建議）",
        "year": 2020,
        "url": "https://ard.bmj.com/content/79/6/713",
        "status": "current",
        "summary_zh": "EULAR 與 ERA-EDTA 聯合發布的狼瘡腎炎管理建議，涵蓋誘導與維持治療。",
        "key_topics": ["狼瘡腎炎", "MMF", "Cyclophosphamide", "EULAR"],
        "rag_status": "not_indexed",
    },
    {
        "org": "ERBP",
        "topic": "GN",
        "title": "ANCA-Associated Vasculitis (EULAR/ERA-EDTA Joint Recommendations)",
        "title_zh": "ANCA 相關血管炎（EULAR/ERA-EDTA 聯合建議）",
        "year": 2022,
        "url": "https://ard.bmj.com/content/81/2/163",
        "status": "current",
        "summary_zh": "EULAR 與 ERA-EDTA 聯合發布的 ANCA 血管炎管理建議，含 Rituximab 與 Avacopan。",
        "key_topics": ["ANCA 血管炎", "Rituximab", "Avacopan", "EULAR"],
        "rag_status": "not_indexed",
    },
]
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="寫入/更新 KDIGO/KDOQI/NICE/ERBP 指引 metadata 到 Firestore")
